...
_1698: () => Date.now(),
_1699: () => new XMLHttpRequest(),
_1700: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
_1701: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
_1702: (x0,x1) => x0.send(x1),
_1703: x0 => x0.abort(),
_1704: x0 => x0.getAllResponseHeaders(),
_1713: f => finalizeWrapper(f,x0 => dartInstance.exports._1713(f,x0)),
_1714: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
